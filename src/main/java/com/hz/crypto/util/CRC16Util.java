...
import com.hz.convert.util.HexUtil;
...
public class CRC16Util {
     ...
     * @return CRC16校验值
     */
    public static int computeCrc16(byte[] data, int offset, int len) {
        return computeCrc16(data, offset, len, 0xffff);
    }
     ...
     * @return CRC16校验值
     */
    public static int computeCrc16(byte[] data, int offset, int len, int preval) {
     ...
     * @return
     */
    public static String getCrc16(int res) {
     ...
     * crc16校验
     *
     * @param str 需要计算的16进制字符
     * @return
     */
    public static String checkCrc16(String str) {
